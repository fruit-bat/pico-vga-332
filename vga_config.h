...
// === Configuration
#define MAXX		360 //640	// max. resolution in X direction (must be power of 4)
#define MAXY		288 //480	// max. resolution in Y direction

#define MAXLINE		625 //700	// max. number of scanlines (including sync and dark lines)
